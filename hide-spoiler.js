kw = ['Gauntlet','spoiler alert end game','Avengers: Endgame','Avengers:Endgame','gauntlet','tony stark dead','Iron Man dead','Captain America','End Game','End Game Spoiler','Avengers End Game','Avengers End Game Spoiler','Dead','thanos dead','tony stark dead','iron man dead','end game','end game spoiler','avengers end game','avengers end game spoiler','dead','time travel']
tags = "SPANEMBIULOLI";
total = 0;
